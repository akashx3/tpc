-- 
ADMIN CLEAN TRASH;
set global enable_spilling=1;
set global enable_sql_cache=0;
set GLOBAL enable_spill=1;

set global  enable_sort_aggregate=1 	 ;

SHOW TABLE STATS catalog_sales ;
show variables like '%profile%';



SHOW PROC '/backends';
ALTER SYSTEM DECOMMISSION BACKEND "10.0.131.224:9050";

ALTER SYSTEM add BACKEND  "10.0.129.134:9050";


SHOW PROC '/backends';
show database;
ALTER TABLE table_statistic_v1  SET ("default.replication_num" = "1");

set GLOBAL default_replication_num=1;
...
CREATE DATABASE IF NOT EXISTS iceberg_db1;
CREATE DATABASE IF NOT EXISTS iceberg.iceberg_db;
SHOW CREATE DATABASE iceberg_db;
select iceberg.iceberg_db;
-- Create unpartitioned iceberg table
CREATE TABLE `measurements4` (
...
INSERT INTO measurements_1row (station_name,measurement)
VALUES ("Bangalore", 25);

INSERT INTO measurements4
SELECT * FROM internal.tpch.measurements2;

select * from internal.tpch.measurements2;



select * from call_center cc 
where cc_employees=6879074;
SHOW VERBOSE RESOURCE GROUPS ;

SHOW PROC '/current_queries' ;
SHOW PROC '/global_current_queries';
-- ---------------------------------------------------
select *  from(  -- 6347386005
 SELECT 'call_center' as table_name, count(*) as count_of_rows from call_center cc  
 UNION
 SELECT 'catalog_page' as table_name, count(*) as count_of_rows  from catalog_page cp  
 UNION
SELECT 'catalog_returns' as table_name, count(*) as count_of_rows
from catalog_returns cr 
UNION
SELECT 'catalog_sales ' as table_name, count(*) as count_of_rows
from catalog_sales cs  UNION
SELECT 'customer ' as table_name, count(*) as count_of_rows
from customer c  
UNION
SELECT 'customer_address ' as table_name, count(*) as count_of_rows
from customer_address ust  UNION
SELECT 'customer_demographics  ' as table_name, count(*) as count_of_rows
from customer_demographics ust  
union
SELECT 'date_dim  ' as table_name, count(*) as count_of_rows
from date_dim dd 
union
SELECT 'household_demographics  ' as table_name, count(*) as count_of_rows
from household_demographics hd  
union
SELECT 'income_band  ' as table_name, count(*) as count_of_rows
from income_band ib  
union
SELECT 'inventory  ' as table_name, count(*) as count_of_rows
from inventory i  
union
SELECT 'item  ' as table_name, count(*) as count_of_rows
from item i  
union
SELECT 'promotion  ' as table_name, count(*) as count_of_rows
from promotion p  
union
SELECT 'reason  ' as table_name, count(*) as count_of_rows
from reason r  
union
SELECT 'ship_mode  ' as table_name, count(*) as count_of_rows
from ship_mode sm  
union
SELECT 'store  ' as table_name, count(*) as count_of_rows
from store s  
union
SELECT 'store_returns  ' as table_name, count(*) as count_of_rows
from store_returns sr  
union
SELECT 'store_sales  ' as table_name, count(*) as count_of_rows
from store_sales ss  
union
SELECT 'time_dim  ' as table_name, count(*) as count_of_rows
from time_dim td  
union
SELECT 'warehouse  ' as table_name, count(*) as count_of_rows
from warehouse w  
union
SELECT 'web_page  ' as table_name, count(*) as count_of_rows
from web_page wp  
union
SELECT 'web_returns  ' as table_name, count(*) as count_of_rows
from web_returns wr  
union
SELECT 'web_sales  ' as table_name, count(*) as count_of_rows
from web_sales ws  
union
SELECT 'web_site  ' as table_name, count(*) as count_of_rows
from web_site ws  
) as t
...
-- ----------------------------------------------
ANALYZE PROFILE FROM '11c341cf-7668-11ef-84f4-fa163e2a67ae';

-- ALTER SESSION SET USE_CACHED_RESULT = FALSE;   --        select ''

-- query 1
-- TRACE TIMES OPTIMIZER 
-- EXPLAIN  costs 
 ...
 from
  ( select  cs_catalog_page_sk as page_sk,
    ...
    from catalog_returns
     ...
     catalog_page
 where date_sk = d_date_sk
       and d_date between cast('2000-08-23' as date) and  cast('2000-08-23' as date)
               --   and date_add(cast('2000-08-23' as date),  14)
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1999-02-22' as date) and cast('1999-03-22' as date) 
...
with  cross_items as
 ...
 select ics.i_brand_id
     ,ics.i_class_id
     ,ics.i_category_id
 from  internal.tpcds.catalog_sales
     ,item ics
     ,date_dim d2
...
from
  ...
  ,call_center
where
    d_date between '2002-2-01' and '2002-4-01'
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between cast ('2000-02-11' as date) and cast ('2000-04-11' as date)
      -- date_add(cast ('2000-03-11' as date), -30)    and date_add(cast ('2000-03-11' as date), 30)
...
and d_date between '2000-01-27' and '2000-04-27' 
...
select  i_item_id
 ...
 -- date_add(cast('2000-02-01' as date),  60)
...
with ss as
 ...
 from store_sales,
      ...
      store
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-23' as date) and  cast('2000-09-23' as date) 
...
SWITCH internal;
SWITCH iceberg_s3; -- internal.tpcds.
use tpcds ;
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-05-25' as date) and cast('2000-07-25' as date)
 -- date_add(cast('2000-05-25' as date),  60)
...
from
  ...
  ,web_site
where
    d_date between '1999-2-01' and '1999-4-01'
