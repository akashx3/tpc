...
-- alter WAREHOUSE IDENTIFIER('"COMPUTE_WH"') set WAREHOUSE_SIZE = 'Medium';
...
END_TIME_RANGE_START=>to_timestamp_ltz('2024-09-5 00:00:00.000 -0700'),
END_TIME_RANGE_END=>to_timestamp_ltz('2024-09-13 00:00:00.000 -0700')))
limit 1000;


select *
from aggregate_query_history
